...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      {/* Hero Section */}
      <section className="relative text-white h-[300px] sm:h-[200px] md:h-[400px]">
  {/* Background Image */}
  <div className="absolute inset-0 z-0">
    <Image src="/images/Banner for website.png" alt="Contact Banner" fill className="object-cover" priority />
